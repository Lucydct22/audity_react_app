...
export async function postPlaylistAction(dispatch: any, userId: any, data: any, token: any, messageApi: any) {
  try {
    ...
    const postPlaylistImage: any = await api.updatePlaylistImageApi(
      postPlaylist.playlist._id,
...
export async function updatePlaylistAction(
  ...
  try {
    ...
    if (data.image?.file.originFileObj) {
      const playlistImageToUpdate = await api.updatePlaylistImageApi(
        playlist._id,
        data.image.file.originFileObj,
        token
      );
...
export async function updatePlaylistPublicAccessibleAction(
  playlist: any,
  ...
  try {
    const updatePublicAccessible = await api.updatePlaylistPublicAccessibleApi(
      playlist._id,
      publicAccessible,
      token
    );
