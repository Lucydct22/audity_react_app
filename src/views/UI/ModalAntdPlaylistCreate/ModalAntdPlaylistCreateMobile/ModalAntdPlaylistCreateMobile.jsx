    ...
    <section className="modal-playlist-create-mobile">
      <div className="modal-playlist-create-mobile--container">
        <div className="modal-playlist-create-mobile--container__header">
          <button onClick={onClose} className="modal-playlist-create-mobile--container__header__btn-close">
            <IoChevronBackOutline />
          </button>
          <h2 className="modal-playlist-create-mobile--container__header__text">
          ...
          <div className="modal-playlist-create-mobile--container__main--content">
            ...
            <div className="modal-playlist-create-mobile--container__main--content__desc-input">
              ...
              <textarea
                ...
                type="text"
                rows="2"
                placeholder={t('library_modal_artist_placeholder_desc')}
              />
            </div>
          </div>
        </div>
        <button
          className="modal-playlist-create-mobile--container__footer-btn"
