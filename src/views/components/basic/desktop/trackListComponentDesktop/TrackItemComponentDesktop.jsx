  ...
  const popoverContent = isAuthenticated ? (
    <>
      <div className="track-item-component-add-to-playlist">
        <div
          className="track-item-component-add-to-playlist__add"
          onClick={() => {
            confirm();
            hidePopover();
          }}
    ...
    <div className="track-item-component-add-to-playlist-without-login">
      {t('player_component_popover_playlist')}
    </div>
  );
