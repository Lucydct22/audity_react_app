    ...
    <nav className="side-bar">
      <div className="side-bar-header">
        ...
        <div className="side-bar-header__sections">
          ...
          >
            <div className="side-bar-header__sections--options__decoration"></div>
            <SlCompass size={20} className="side-bar-header__sections--options__icon" />
            ...
            <div>
              <div>
                <NavLink to={'/artists'} className="side-bar-header__sections--options">
                  <div className="side-bar-header__sections--options__decoration"></div>
                  <FaGuitar size={15} className="side-bar-header__sections--options__icon--dropdown" />
                  <p className="side-bar-header__sections--options__icon--dropdown">
                    {t('sidebar_explore_artist')}
                  </p>
                </NavLink>
          ...
          <NavLink to={isGuest ? '/offers' : '/library'} className="side-bar-header__sections--options">
            <div className="side-bar-header__sections--options__decoration"></div>
            <VscLibrary size={20} className="side-bar-header__sections--options__icon" />
