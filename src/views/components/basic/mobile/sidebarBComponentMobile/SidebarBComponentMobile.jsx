      ...
      <div className="side-bar-mobile-header">
        <div className="side-bar-mobile-header__sections">
          <NavLink to={'/'} className="side-bar-mobile-header__sections--options">
            <FiMusic size={20} className="side-bar-mobile-header__sections--options__icon" />
            <p>{t('sidebar_music')}</p>
          </NavLink>

          <NavLink to={'/explore'} className="side-bar-mobile-header__sections--options">
            <SlCompass size={20} className="side-bar-mobile-header__sections--options__icon" />
            <p>{t('sidebar_explore')}</p>
          </NavLink>

          <NavLink to={'/search'} className="side-bar-mobile-header__sections--options">
            <FiSearch size={20} className="side-bar-mobile-header__sections--options__icon" />
          ...
          >
            ...
            <VscLibrary size={20} className="side-bar-mobile-header__sections--options__icon" />
