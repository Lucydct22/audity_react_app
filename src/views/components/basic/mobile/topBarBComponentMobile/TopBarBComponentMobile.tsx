  ...
  return (
    <header className="page-topbar-mobile">
      <div className="page-topbar-mobile-action" ref={popperRef}>
        ...
        <div
          className={`page-topbar-mobile-action__popper ${popperOpen ? 'popperActive' : 'popperInactive'}`}
        >
          <div className="page-topbar-mobile-action__popper--wrapper">
            ...
            {isAuthenticated ? (
              <Link to="/settings">
                <div className="page-topbar-mobile-action__popper--wrapper__content cursor-pointer">
              ...
              <div
                className="page-topbar-mobile-action__popper--wrapper__content cursor-pointer"
