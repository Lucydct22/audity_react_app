...
const PlayerBComponentMobile = () => {
  ...
  const { trackData, currentTrack, playCurrentTrack, pauseCurrentTrack, nextTrack } =
      ...
      <div className="page-player-mobile">
        <div className="player-bottom-mobile">
          ...
          <div className="player-bottom-track-mobile" onClick={() => setShowPopUp(true)}>
            <div className="player-bottom-track-mobile__title">{currentTrack.name}</div>
            <div className="player-bottom-track-mobile__artist">{artists}</div>
          </div>

          <div className="player-bottom-controls-mobile">
            <button
              className="player-bottom-controls-mobile__btn"
              onClick={() => (isGuest ? handleGuest() : likeDislikeTrack(currentTrack))}
            >
