  ...
  return (
    <div style={{ maxWidth: 600, margin: '0 auto' }}>
      ...
      <Form
        ...
        onFinish={(values) =>
          !artistId ? postArtist(values, messageApi) : updateArtist(values, findArtist, messageApi)
        }
      ...
      >
        ...
        <Form.Item label="Albums" name="albums">
          <Select
            mode="multiple"
            allowClear
            style={{ width: '100%' }}
        ...
        <Form.Item label="Tracks" name="tracks">
          <Select
            mode="multiple"
            allowClear
            style={{ width: '100%' }}
        ...
        <Form.Item label="Playlists" name="playlists">
          <Select
            mode="multiple"
            allowClear
            style={{ width: '100%' }}
        ...
        >
          <Upload name="avatar" listType="picture-card" maxCount={1} showUploadList={true}>
            Upload Image
          </Upload>
        </Form.Item>
        <div style={{ display: 'flex', justifyContent: 'center', paddingBottom: 15 }}>
          <Image width={400} src={findArtist?.imageUrl} />
        </div>
