  ...
  return (
    <div style={{ maxWidth: 600, margin: '0 auto' }}>
      ...
      <Form
        ...
        onFinish={(values) =>
          !trackId ? postTrack(values, messageApi) : updateTrack(values, track, messageApi)
        }
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', paddingBottom: 15 }}>
          <Image width={400} src={track?.imageUrl} />
        </div>
        <Form.Item
          label="Audio"
          name="audio"
        ...
        >
          <Upload name="audio" listType="picture-card" maxCount={1} showUploadList={true}>
            Upload Audio
          </Upload>
        </Form.Item>
        <div style={{ display: 'flex', justifyContent: 'center', paddingBottom: 15 }}>
