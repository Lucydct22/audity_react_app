...
export default function MyLibraryProvider(props: ChildrenProps) {
  ...
  const postPlaylist = useCallback(
  ...
  const postPrivateTrack = useCallback(
    async (data: any) => {
  ...
  const putTrackToPlaylist = useCallback(
  ...
  const likeDislikeTrack = useCallback(
  ...
  const likeDislikeArtist = useCallback(
  ...
  const likeDislikeAlbum = useCallback(
  ...
  const likeDislikePlaylist = useCallback(
  ...
  return <MyLibraryContext.Provider value={memoProvider}>{props.children}</MyLibraryContext.Provider>;
}
