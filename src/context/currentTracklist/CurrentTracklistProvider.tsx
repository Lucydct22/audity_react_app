...
export default function CurrentTracklistProvider({ children }: any) {
  ...
  const memoProvider = useMemo(
    ...
    [tracklistState, shuffleTracklist, selectAlbum, selectArtist, selectPlaylist, selectGenre]
  );

  return <CurrentTracklistContext.Provider value={memoProvider}>{children}</CurrentTracklistContext.Provider>;
}
